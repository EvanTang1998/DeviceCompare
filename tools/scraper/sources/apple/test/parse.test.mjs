...
// 运行：node sources/apple/test/parse.test.mjs

import { appleModelToDeviceId, modelMatchKeys, norm } from "../naming.mjs";
import { parseCompareImageUrl, buildModelIndex, imageIdentity } from "../images.mjs";
